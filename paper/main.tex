...
\makeatletter
\newlength{\gitwrathlistingcaptiongap}
\setlength{\gitwrathlistingcaptiongap}{0.9\baselineskip}
\let\gitwrath@orig@lst@makecaption\lst@makecaption
\def\lst@makecaption#1#2{%
  \gitwrath@orig@lst@makecaption{#1}{#2}%
  \par\nobreak\vskip\gitwrathlistingcaptiongap\nobreak
}
\makeatother
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/vgit-tui-tests-vti.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/vgit-tui-evidence.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/vgit-tui-release.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/vgit-tui-mission.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{assets/vgit-tui-agents.png}
