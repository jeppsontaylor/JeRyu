...
\apicmd{jeryu serve} & daemon & Start Docker/GitLab orchestration, hook install, cache supervisor, runner warmup, engine, and shadow loop.\\
...
\apicmd{jeryu shadow <subcommand>} & mixed & Manage periodic local source-to-GitLab shadow sync: add, enable, disable, remove, sync-now, status.\\
\apicmd{jeryu shadow-remote <subcommand>} & mixed & Inspect, create, or push a repo-local shadow remote: status, ensure, push.\\
...
jeryu shadow add --source <path> --project-id <id> --branch <branch> [--enable]
jeryu shadow enable --source <path>
jeryu shadow disable --source <path>
jeryu shadow remove --source <path>
jeryu shadow sync-now --source <path>
jeryu shadow status [--source <path>]

jeryu shadow-remote status [--repo <path>] [--name <remote>]
jeryu shadow-remote ensure [--repo <path>] [--name <remote>] --url <url>
jeryu shadow-remote push [--repo <path>] [--name <remote>] [--branch <branch>] [--mirror]
